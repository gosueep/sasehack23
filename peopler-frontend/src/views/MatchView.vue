          ...
          profiles: [
            {
              name: 'Bob',
              pronouns: 'they/them',
              desc: 'Bob likes to ski. <This description should be generated by ChatGPT based on shared interests and hobbies. See the second one for an example.>'
            },
            {
              name: 'Will',
              pronouns: 'he/him',
            ...
            },
            {
              name: 'Eugin',
              pronouns: 'he/him',
              desc: "Meet Eugin, an adventurous and intellectually stimulating individual who shares your love for chess. With a passion for camping, skiing, and rock climbing, Will's zest for life will surely captivate you. Join him for exciting cosplay conventions and trivia nights!"
            }
          ]
        }
      }
